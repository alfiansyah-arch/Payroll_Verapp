...
class PerformanceAppraisement extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('performance_appraisement', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('performance_appraisement');
    }
}
